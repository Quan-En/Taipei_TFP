...
parser.add_argument("--config", default='configurations/TMCOVID_astgcn.conf', type=str,
...
lstm_net = LSTM(input_dim=4, hidden_dim=50, num_layers=1, output_dim=119).to(DEVICE)
...
def train_main():
    ...
    predict_main(best_epoch, test_loader, test_target_tensor, _mean[:,:,:2,:], _std[:,:,:2,:], 'test')
...
if __name__ == "__main__":
    ...
    predict_main(31, test_loader, test_target_tensor, _mean[:,:,:2,:], _std[:,:,:2,:], 'test')